...
$refFileName = '?vw=uploadwinccrisA&mn=' . $mn . '&pk=' . $pk . '&action=upload';
...
if ($action == 'upload') {
    ...
    if (in_array($file_ext, $allowed_file_types) && ($filesize < 1048576)) {
        ...
        if (file_exists("upload_CCRIS/" . $newfilename)) {
            ...
            header("Location: ?vw=uploadwinccrisA&mn=$mn&pk=$pk&action=upload");
            exit();
        } else {
...
<div class="file-upload">
    ...
    <div class="mt-3">
        Description :
        <input type="text" lenght="30" size="86" class="form-control" id="desc_ccris" name="desc_ccris">
    </div>
</div>
<?php
...
print '
	<center>
		<input type="button" class="btn waves-effect waves-light" value="Kembali" style="background-color: white; color: #495057; border: 1px solid gray;" onClick="window.location.href=\'?vw=biayaEditA&mn=' . $mn . '&pk=' . $pk . '\';">
