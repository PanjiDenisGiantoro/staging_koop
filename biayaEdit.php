...
if ($pk) {
	$loanID = $pk;
	$pk = dlookup("loans", "userID", "loanID=" . $pk);
}
...
if (get_session("Cookie_groupID") == 0) $sActionFileName = "?vw=biayaEdit&mn=3";
else $sActionFileName = "?vw=biayaEdit&mn=3&pk=" . $loanID;
...
if (isset($_GET['action']) && $_GET['action'] == "delete" && isset($_GET['userID']) && isset($_GET['type'])) {
	$userID = $_GET['userID'];
	$type = $_GET['type'];
	...
	if ($type == 'gaji_img') {
		...
		$filename = dlookup("userloandetails", "gaji_img", "userID=" . tosql($userID, "Number"));
		// Lokasi fail Info
		...
		$sWhere = "userID=" . tosql($userID, "Number");
		$sSQL = "UPDATE userloandetails SET gaji_img = '0' WHERE " . $sWhere;
		$rs = $conn->Execute($sSQL);
	} else if ($type == 'ic_img') {
		$filename = dlookup("userloandetails", "ic_img", "userID=" . tosql($userID, "Number"));
		// Lokasi fail Info
		...
		$filename = dlookup("userloandetails", "jwtn_img", "userID=" . tosql($userID, "Number"));
		// Lokasi fail Info
		...
		$filename = dlookup("userloandetails", "ccris_img", "userID=" . tosql($userID, "Number"));
		// Lokasi fail Info
		...
		$filename = dlookup("userloandetails", "lain_img", "userID=" . tosql($userID, "Number"));
		// Lokasi fail Info
...
if (get_session("Cookie_groupID") == 0) {
	...
	if (!isset($picgaji)) $picgaji = dlookup("userloandetails", "gaji_img", "userID=" . tosql($userID, "Text"));
	$Gambar = "upload_gaji/" . $pic;
	if (!isset($picjwtn)) $picjwtn = dlookup("userloandetails", "jwtn_img", "userID=" . tosql($userID, "Text"));
	$Gambarjwtn = "upload_jwtn/" . $pic;
	if (!isset($picic)) $picic = dlookup("userloandetails", "ic_img", "userID=" . tosql($userID, "Text"));
	$Gambaric = "upload_ic/" . $pic;
	if (!isset($picccris)) $picccris = dlookup("userloandetails", "ccris_img", "userID=" . tosql($userID, "Text"));
	$Gambarccris = "upload_CCRIS/" . $pic;
	if (!isset($picother)) $picother = dlookup("userloandetails", "lain_img", "userID=" . tosql($userID, "Text"));
	$Gambarother = "upload_lain/" . $pic;
}
...
<div class="card-header mt-3 d-flex justify-content-between align-items-center">
    ...
    <div>
		Kemaskini Pendapatan&nbsp;&nbsp;&nbsp;<a href="?vw=biayaEditAdd&mn=3&payType=A&userID=' . $pk . '&loanID=' . $loanID . '" style="font-size: 24px;" class="fas fa-pencil-alt" onClick="window.location.href=\'?vw=biayaEditAdd&mn=3&payType=A&userID=' . $pk . '&loanID=' . $loanID . '\')" title="Ubah"> </a>
    </div>
    </div>
</div>';
	...
	while (!$rsdpt->EOF) {
		...
		/*
				...
				<td class="Data">
					...
					<font face="Verdana, Poppins, Helvetica, sans-serif" size="-2" color="#0000FF">
...
print '
		<div class="card-header mt-3 d-flex justify-content-between align-items-center">
			...
			<div>
				Kemaskini Perbelanjaan&nbsp;&nbsp;&nbsp;<a href="?vw=biayaEditAdd&mn=3&payType=B&userID=' . $pk . '&loanID=' . $loanID . '" style="font-size: 24px;" class="fas fa-pencil-alt" onClick="window.location.href=\'?vw=biayaEditAdd&mn=3&payType=B&userID=' . $pk . '&loanID=' . $loanID . '\')" title="Ubah"> </a>
			</div>
			</div>
		</div>';
...
if (get_session("Cookie_groupID") == 0) {
	print '
		<tr>
			...
			<td>			
				<div class="col-md-8 col-form-label"><input type="button" class="btn btn-outline-primary" name="GetPicture" value="Muat Naik"  onclick= "Javascript:(window.location.href=\'?vw=uploadwingaji&mn=' . $mn . '&userID=' . $pk . '\')" /></div>
			</td>';
	...
	if ($picgaji) {
		print '
					...
					<td align="center" style="vertical-align: middle;"><a href="?vw=biayaEdit&mn=3&action=delete&userID=' . $userID . '&type=gaji_img" onClick="return confirm(\'Adakah anda pasti untuk hapus permohonan ini?\')" title="Hapus"><i class="fas fa-trash-alt fa-lg text-danger"></i></a></td>';
	} else {
		print '<td>&nbsp;</td>
					   <td>&nbsp;</td>';
	}
	...
	if ($picic) {
		print '
					...
					<td align="center" style="vertical-align: middle;"><a href="?vw=biayaEdit&mn=3&action=delete&userID=' . $userID . '&type=ic_img" onClick="return confirm(\'Adakah anda pasti untuk hapus permohonan ini?\')" title="Hapus"><i class="fas fa-trash-alt fa-lg text-danger"></i></a></td>';
	} else {
		print '<td>&nbsp;</td>
					   <td>&nbsp;</td>';
	}
	print '
		...
		<tr>
			...
			<td>
				<div class="col-md-8 col-form-label"><input type="button" class="btn btn-outline-primary" name="GetPicture" value="Muat Naik"  onclick= "Javascript:(window.location.href=\'?vw=uploadwinjwtn&mn=3&userID=' . $pk . '\')"></div>
			</td>';
	...
	if ($picjwtn) {
		print '
					...
					<td align="center" style="vertical-align: middle;"><a href="?vw=biayaEdit&mn=3&action=delete&userID=' . $userID . '&type=jwtn_img" onClick="return confirm(\'Adakah anda pasti untuk hapus permohonan ini?\')" title="Hapus"><i class="fas fa-trash-alt fa-lg text-danger"></i></a></td>';
	} else {
		print '<td>&nbsp;</td>
					   <td>&nbsp;</td>';
	}
	print '
		...
		<tr>
			...
			<td>
			<div class="col-md-8 col-form-label"><input type="button" class="btn btn-outline-primary" name="GetPicture" value="Muat Naik"  onclick= "Javascript:(window.location.href=\'?vw=uploadwinccris&mn=3&userID=' . $pk . '\')"></div>
			</td>';
	...
	if ($picccris) {
		print '
					...
					<td align="center" style="vertical-align: middle;"><a href="?vw=biayaEdit&mn=3&action=delete&userID=' . $userID . '&type=ccris_img" onClick="return confirm(\'Adakah anda pasti untuk hapus permohonan ini?\')" title="Hapus"><i class="fas fa-trash-alt fa-lg text-danger"></i></a></td>';
	} else {
		print '<td>&nbsp;</td>
					   <td>&nbsp;</td>';
	}
	print '
		...
		<tr>
			...
			<td>
			<div class="col-md-8 col-form-label"><input type="button" class="btn btn-outline-primary" name="GetPicture" value="Muat Naik"  onclick= "Javascript:(window.location.href=\'?vw=uploadwinlain&mn=3&userID=' . $pk . '\')"></div>
			</td>';

	if ($picother) {
		print '
					<td class="align-middle"><a href type=button onClick=window.open(\'upload_lain/' . $picother . '\',"pop","top=50,left=50,width=700,height=450,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no");> <i class="far fa-file-pdf text-danger"></i> Paparan Lain-lain</td>
					<td align="center" style="vertical-align: middle;"><a href="?vw=biayaEdit&mn=3&action=delete&userID=' . $userID . '&type=lain_img" onClick="return confirm(\'Adakah anda pasti untuk hapus permohonan ini?\')" title="Hapus"><i class="fas fa-trash-alt fa-lg text-danger"></i></a></td>';
	} else {
		print '<td>&nbsp;</td>
					   <td>&nbsp;</td>';
	}
	...
	print '
		<tr>
			<td class="align-middle">* Slip Gaji</td>
			<td>			
				<div class="col-md-8 col-form-label"><input type="button" class="btn btn-outline-primary" name="GetPicture" value="Muat Naik"  onclick= "Javascript:(window.location.href=\'?vw=uploadwingaji&mn=906' . $strpk . '&userID=' . $userID . '\')" /></div>
			</td>';

	if ($picgaji) {
		print '
					<td class="align-middle"><a href onClick=window.open(\'upload_gaji/' . $picgaji . '\',"pop","top=50,left=50,width=700,height=450,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no");> <i class="far fa-file-pdf text-danger"></i> Paparan Slip Gaji</td>
					<td align="center" style="vertical-align: middle;"><a href="?vw=biayaEdit&mn=906&action=delete' . $strpk . '&userID=' . $userID . '&type=gaji_img" onClick="return confirm(\'Adakah anda pasti untuk hapus permohonan ini?\')" title="Hapus"><i class="fas fa-trash-alt fa-lg text-danger"></i></a></td>';
	} else {
		print '<td>&nbsp;</td>
					   <td>&nbsp;</td>';
	}
	...
	if ($picic) {
		print '
					<td class="align-middle"><a href onClick=window.open(\'upload_ic/' . $picic . '\',"pop","top=50,left=50,width=700,height=450,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no");> <i class="far fa-file-pdf text-danger"></i> Paparan IC</td>
					<td align="center" style="vertical-align: middle;"><a href="?vw=biayaEdit&mn=906&action=delete' . $strpk . '&userID=' . $userID . '&type=ic_img" onClick="return confirm(\'Adakah anda pasti untuk hapus permohonan ini?\')" title="Hapus"><i class="fas fa-trash-alt fa-lg text-danger"></i></a></td>';
	} else {
		print '<td>&nbsp;</td>
					   <td>&nbsp;</td>';
	}
	print '
		...
		<tr>
			<td class="align-middle">Jawatan Tetap</td>
			<td>
				<div class="col-md-8 col-form-label"><input type="button" class="btn btn-outline-primary" name="GetPicture" value="Muat Naik"  onclick= "Javascript:(window.location.href=\'?vw=uploadwinjwtn&mn=906' . $strpk . '&userID=' . $userID . '\')"></div>
			</td>';

	if ($picjwtn) {
		print '
					<td class="align-middle"><a href onClick=window.open(\'upload_jwtn/' . $picjwtn . '\',"pop","top=50,left=50,width=700,height=450,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no");> <i class="far fa-file-pdf text-danger"></i> Paparan Pengesahan Jawatan</td>
					<td align="center" style="vertical-align: middle;"><a href="?vw=biayaEdit&mn=906&action=delete' . $strpk . '&userID=' . $userID . '&type=jwtn_img" onClick="return confirm(\'Adakah anda pasti untuk hapus permohonan ini?\')" title="Hapus"><i class="fas fa-trash-alt fa-lg text-danger"></i></a></td>';
	} else {
		print '<td>&nbsp;</td>
					   <td>&nbsp;</td>';
	}
	print '
		...
		<tr>
			<td class="align-middle">CCRIS</td>
			<td>
			<div class="col-md-8 col-form-label"><input type="button" class="btn btn-outline-primary" name="GetPicture" value="Muat Naik"  onclick= "Javascript:(window.location.href=\'?vw=uploadwinccris&mn=906' . $strpk . '&userID=' . $userID . '\')"></div>
			</td>
			';
	...
	if ($picccris) {
		print '
					<td class="align-middle"><a href type=button onClick=window.open(\'upload_CCRIS/' . $picccris . '\',"pop","top=50,left=50,width=700,height=450,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no");> <i class="far fa-file-pdf text-danger"></i> Paparan CCRIS</td>
					<td align="center" style="vertical-align: middle;"><a href="?vw=biayaEdit&mn=906&action=delete' . $strpk . '&userID=' . $userID . '&type=ccris_img" onClick="return confirm(\'Adakah anda pasti untuk hapus permohonan ini?\')" title="Hapus"><i class="fas fa-trash-alt fa-lg text-danger"></i></a></td>';
	} else {
		print '<td>&nbsp;</td>
					       <td>&nbsp;</td>';
	}
	print '
		...
		<tr>
			<td class="align-middle">Lain-lain</td>
			<td>
			<div class="col-md-8 col-form-label"><input type="button" class="btn btn-outline-primary" name="GetPicture" value="Muat Naik"  onclick= "Javascript:(window.location.href=\'?vw=uploadwinlain&mn=906' . $strpk . '&userID=' . $userID . '\')"></div>
			</td>
			';
	...
	if ($picother) {
		print '
					<td class="align-middle"><a href type=button onClick=window.open(\'upload_lain/' . $picother . '\',"pop","top=50,left=50,width=700,height=450,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no");> <i class="far fa-file-pdf text-danger"></i> Paparan Lain-lain</td>
					<td align="center" style="vertical-align: middle;"><a href="?vw=biayaEdit&mn=906&action=delete' . $strpk . '&userID=' . $userID . '&type=lain_img" onClick="return confirm(\'Adakah anda pasti untuk hapus permohonan ini?\')" title="Hapus"><i class="fas fa-trash-alt fa-lg text-danger"></i></a></td>';
	} else {
		print '<td>&nbsp;</td>
					       <td>&nbsp;</td>';
	}
...
if (!$user) print '<input type=button name=ResetForm class="btn btn-md waves-light waves-effect btn-secondary" value=<< onClick="window.location.href =\'?vw=biaya&pk=' . $loanID . '&userID=' . $userID . '\'">&nbsp;'; //back button for admin.
print '</center>
</table></form>';
include("footer.php");
