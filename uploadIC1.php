...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Pastikan semua gambar dimuat naik
    if (count($uploadData) === 3) { // Memastikan ada tiga gambar dimuat naik
        $frontImage = isset($uploadData['front']) ? $uploadData['front'] : null;
        $backImage = isset($uploadData['back']) ? $uploadData['back'] : null;
        $picture = isset($uploadData['selfie']) ? $uploadData['selfie'] : null;
        ...
        $sSQLUpd = "UPDATE userdetails SET " .
            ...
            ",frontImage=" . tosql($frontImage, "Text") .
            ",backImage=" . tosql($backImage, "Text") .
        ...
        echo '<script>alert("Sila muat naik kesemua gambar (Gambar Depan, Gambar Belakang, Gambar Selfie)!");</script>';
    }
}
...
<body>
    <div class="container mt-5">
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="upload-container row">
                <!-- <div class="upload-box col-12 col-md-4" id="frontBox">
                    <div class="image-preview" id="frontPreview">Gambar Depan IC</div>
                    <input type="file" name="fileInputfront" id="fileInputfront" style="display: none;" accept="image/*" onchange="previewImage(event, 'front')">
                </div>
                <div class="upload-box col-12 col-md-4" id="backBox">
                    <div class="image-preview" id="backPreview">Gambar Belakang IC</div>
                    <input type="file" name="fileInputback" id="fileInputback" style="display: none;" accept="image/*" onchange="previewImage(event, 'back')">
                </div> -->
    ...
    <script>
        ...
        document.getElementById('frontBox').addEventListener('click', () => document.getElementById('fileInputfront').click());
        document.getElementById('backBox').addEventListener('click', () => document.getElementById('fileInputback').click());
