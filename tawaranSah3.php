...
for ($i = 1; $i <= count($FormLabel); $i++) {
	...
	if ($i == 1) print '<tr><td class=Header colspan=4>i. PENGESAHAN ON-LINE DOKUMEN PEMBIAYAAN TELAH LENGKAP DAN SEMPURNA SERTA PERPOHONAN UNTUK MENGELUARKAN PEMBIAYAAN</td></tr>';
