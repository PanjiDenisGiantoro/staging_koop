...
$title     = "Senarai Potongan Gaji (PGB) Pembiayaan / Wajib Dan SPSN BERSARA";
	...
	<tr><td	class="Label" align="center" height=50 valign=middle>
      ...
      <td colspan="3" nowrap><div align="center">Edit</div></td>
	    ...
	    <td class="Data" align="right" >&nbsp;';
				if ($IDtype == $GetMember->fields(userID)) {
					print '&nbsp;<input size="30" id="catatan" name="catatan" value="' . $GetMember->fields(catatan) . '"> ';
				} else {
					print '&nbsp;' . $GetMember->fields(catatan) . '';
				}

				print '</td>	
      <td class="Data" align="center" width="5%">&nbsp;<a href="' . $sFileName . '?IDtype=' . $GetMember->fields(userID) . '&ID=' . $userID . '&code=2" title="perbarui"><img src="b_edit.png"></a> <input size="7" type="hidden" name="IDtype" value="' . $IDtype . '" ><input size="7" type="hidden" name="ID" value="' . $ID . '" ></td>
	  ...
	  <td class="Data" align="center" width="5%">';
				if ($IDtype == $GetMember->fields(userID)) {
					print '<input type="submit" size="3" onClick="if(!confirm(\'Adakah ada pasti untuk Kemaskini file ini?\')) {return false} else {window.MyForm.submit();};" name="edit" value="edit" />       
';
				}
