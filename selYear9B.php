...
*          Filename       :  selYear4.php
*          Description    :  Selection Month/Year Option and Debtor Companies Option
*          Parameter      :  $rpt, $id
*          Date           :  15/12/2003
*          Updated        :  09/08/2024
*********************************************************************************/
...
if ($action == "Jana Laporan") {
    ...
    if ($msg <> "") {
        ...
        <script>
            var rptURL;
            rptURL = "'.$rpt.'.php?mthFrom='.$mthFrom.'&yrFrom='.$yrFrom.'&mthTo='.$mthTo.'&yrTo='.$yrTo.'&id='.$kod_bank.'";
...
<form name="FrmSelection" action="'.$PHP_SELF.'" method="post">
    ...
    <table border="0" cellpadding="3" cellspacing="0" class="table table-sm table-striped" style="padding: 1 0 0 0;font-size:9pt" height="100" width="100%" align="center">
        <tr valign="top">
            <td class="textFont" align="right"><b>Bulan/Tahun Dari</b>&nbsp;</td>
            <td class="textFont">
                <select name="mthFrom" class="form-select-xs">';
for ($j = 1; $j < 13; $j++) {
...
print '        </select>
        ...
        <tr valign="top">
            <td class="textFont" align="right"><b>Bulan/Tahun Hingga</b>&nbsp;</td>
            <td class="textFont">
                <select name="mthTo" class="form-select-xs">';
for ($j = 1; $j < 13; $j++) {
    print '            <option value="'.$j.'"';
...
print '            </select>/
            ...
            // Reset the result set pointer to the start
            $rsYears->MoveFirst();
            while (!$rsYears->EOF) {
                $year = $rsYears->fields['year'];
                print '    <option value="'.$year.'"';
...
print '        </select>
        ...
        <tr>
            ...
            <td align="left">'.selectsyarikatAK($kod_bank,'kod_bank').'</td>
        </tr>
        <tr>
