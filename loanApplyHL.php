...
$title = "Pengajuan Pembiayaan Hutang Macet";
...
if ($Kira <> "") {
	...
	if ($houseLoan == 1) { // 75%
		...
		if ($monthlyPymt > $LayakPay50) {
			$layakSDesc = 'Tidak Layak Memohon Nisbah. DSR melebihi 50%. / (SILA KEMASKINI MAKLUMAT PEMBIAYAAN ATAU GAJI TERKINI)Jumlah Maximum Bayaran Balik Bulanan yang dibenarkan RP ' . $LayakPay50 . ' dan DSR ' . number_format($Nisbahdsr, 2) . '%<br><br>';
			$layakS = "N";
			print '<input type="hidden" name="Nisbahdsr" value="' . $Nisbahdsr . '">';
		} else {
