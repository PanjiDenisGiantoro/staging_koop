	...
	if ($page == 'add' or $page == 'edit' or $page == 'view') {
		...
		if ($page == 'view') {
			...
			function selectSyntax($name, $group, $code = 0)
			{
				...
				$arrSyntaxName = array('Nomor Rujukan', 'Alamat', 'Alamat Perjanjian', 'Alamat Surat', 'Tuan/Puan', 'Title', 'Nomor Anggota', 'Nama', 'Kp. Baru', 'Kp. Lama', 'Jab/Caw', 'Tarikh', 'Hari', 'Bulan', 'Tahun', 'Sesi', 'Tarikh. Diterima', 'Tarikh. Lulus', 'Tarikh. Ditolak', 'Tkh. Diterima Berhenti', 'Tkh. Lulus Berhenti', 'Tkh. Ditolak Berhenti', 'Nombor Akaun. Tabungan', 'Nomor Karyawan', 'Wajib Bulan', 'Jum. Wajib Terkumpul', 'Jum. Wajib Tkumpul Bakhir', 'Jum. Dividen', 'Dividen Bonus', 'Persentase Dividen', 'Tanggal Berakhir Asuransi', 'No Plat Kenderaan', 'No Sijil', 'Untung Loan', 'Barang Komoditi');
...
function BeginDataField($bIsDataAvalaible_)
{
	...
	switch ($group) {
		...
		case 1:
		case 4:
			$strNameList_ = array($strCheckboxTemp_, '<b>Nomor Anggota/Nama</b>', '<b>Kartu Identitas</b>', '<b>Tanggal Pengajuan</b>', '<b>Status</b>');
		...
		case 7:
			...
			break;
		case 6:
			$strNameList_ = array($strCheckboxTemp_, '<b>Nomor Anggota/Nama</b>', '<b>Kartu Identitas</b>', '<b>Tanggal Berakhir Asuransi</b>', '<b>Status</b>');
			$strWidthList_ = array('15', '', '', '', '', '');
