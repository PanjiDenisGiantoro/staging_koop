...
*          Filename		: 	investResitReports.php
*          Date 		: 	28/02/2024
*********************************************************************************/
include("header.php");	
...
<div>&nbsp;</div>
	<tr>
		...
		<h6 class="card-subtitle"><u><b>RESIT PELABURAN</b></u></h6>
		<li id="print" class="textFont"><a href="#" onclick="selectResitPelaburan('rptInvest4')">Senarai Resit Pelaburan</a></li>
	</td>
	</tr>
...
<script>
    ...
    function selectInvoisPelaburan(rpt) {
        s = "selInvestInvoisBaucerResit.php";
		url = s + "?rpt=" + rpt;
		window.open(url ,"pop","top=100,left=100,width=500,height=100,scrollbars=no,resizable=no,toolbars=no,location=no,menubar=no");		
    ...
    function selectResitPelaburan(rpt) {
        s = "selInvestInvoisBaucerResit.php";
		url = s + "?rpt=" + rpt;
		window.open(url ,"pop","top=100,left=100,width=500,height=100,scrollbars=no,resizable=no,toolbars=no,location=no,menubar=no");		
