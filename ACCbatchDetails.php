...
print '
	<tr>
		...
		<li id="print" class="textFont">&nbsp;&nbsp;<a href="#" onclick="selectPenyata(\'ACCfastMonth\')">Laporan Wajib Bulanan</a>
		<li id="print" class="textFont">&nbsp;&nbsp;<a href="#" onclick="selectPenyata(\'ACCfastYear\')">Laporan Wajib Tahunan</a>
		</td>
	</tr>
    ';
