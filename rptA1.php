...
$title  = 'Permohonan Menjadi Anggota';

$sSQL = "";
$sSQL = "SELECT	a.name, b.memberID, a.loginID, b.newIC, b.oldIC, a.applyDate, c.name as department  
...
if ($rs->RowCount() <> 0) {
	while (!$rs->EOF) {
		$bil++;
		$member = "Tidak";
		$sqlm = "SELECT * FROM userdetails WHERE newIC = '" . $rs->fields(newIC) . "'";
