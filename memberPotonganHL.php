...
$title     = "Senarai Potongan Gaji (PGB) Pembiayaan / Wajib";
...
print '		</select>
	...
	<tr><td	class="Label" align="center" height=50 valign=middle>
		<hr size="1"><b>- Sila masukkan No / Nama Anggota ATAU pilih Cabang/Zona  -</b><hr size="1">
	</td></tr>';
	} else {
			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						<td nowrap colspan="8" height="20"><b>JUMLAH POTONGAN RP : ' . $SUMALL . '</b></td>
					<tr class="table-primary">
