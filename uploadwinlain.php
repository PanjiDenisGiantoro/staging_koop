...
if (get_session("Cookie_groupID") == 0) {
  ...
  $refFileName = '?vw=uploadwinlain&mn=' . $mn . '&action=upload';
} else {
  $userID = dlookup("loans", "userID", "loanID=" . tosql($pk, "Text"));
  $refFileName = '?vw=uploadwinlain&mn=' . $mn . '&pk=' . $pk . '&userID=' . $userID . '&action=upload';
}
...
print '
	<center>
		<input type="button" class="btn waves-effect waves-light" style="background-color: white; color: #495057; border: 1px solid gray;" value="Kembali" onClick="window.location.href=\'?vw=biayaEdit&mn=3\';">
