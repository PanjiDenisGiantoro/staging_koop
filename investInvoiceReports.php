...
*          Filename		: 	investInvoiceReports.php
*          Date 		: 	28/02/2024
*********************************************************************************/
include("header.php");	
...
<div>&nbsp;</div>
	<tr>
		...
		<h6 class="card-subtitle"><u><b>INVOIS PELABURAN</b></u></h6>
		<li id="print" class="textFont"><a href="#" onclick="selectInvoisPelaburan('rptInvest2')">Senarai Invois Pelaburan</a></li>
	</td>
	</tr>
