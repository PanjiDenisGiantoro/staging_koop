...
*			Filename	: ACCquotationdebtorPrint.php
*			Date 		: 4/8/2006
*********************************************************************************/
if (isset($_GET['session_id']) && !empty($_GET['session_id'])) {
    session_id($_GET['session_id']); // Restore session manually
}
session_start(); // Start or resume the session

// Debugging: Ensure session is being restored
error_log("Session ID inside ACCquotationdebtorPrint.php: " . session_id());
...
<div class="form-container">
    ...
    $addressLines = explode(',', $b_Baddress);
