...
$sActionFileName = "?vw=biayaEditA&mn=" . $mn . "&pk=" . $userID;
...
<input type=button style="background-color: white; color: #495057; border: 1px solid gray;" class="btn btn-light w-md waves-effect waves-light mb-3" value=Kembali onClick="window.location.href=\'?vw=biayaEditA&mn=' . $mn . '&pk=' . $userID . '\';">&nbsp;
