...
if ($GetVouchers->RowCount() <> 0) {
    ...
    while (!$GetVouchers->EOF && $cnt <= $pg) {
        ...
        $edit             = '<a href="' . $sFileRef . '&action=view&SENO=' . tohtml($GetVouchers->fields['SENO']) . '&yy=' . $yy . '&mm=' . $mm . '" title="perbarui"><i class="mdi mdi-lead-pencil text-warning" style="font-size: 1.4rem;"></i></a>';
