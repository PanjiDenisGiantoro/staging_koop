...
*			Filename	: journalsTransferPrint.php
*			Date 		: 04/08/2006
*********************************************************************************/
session_start();
include("common.php");
...
<div class="form-container">
    ...
    <table class="resit-statement">
        <tr class="tr-space"><td>Voucher Pindahan</td></tr>
    ...
    if ($rsDetail->RowCount() <> 0){
		...
		while (!$rsDetail->EOF) {
			...
			$userID	    = $rsDetail->fields(userID);
            $username 	= dlookup("users", "name", "userID=".$userID);
...
print'
			<tr>
                ...
                <td nowrap="nowrap">'.$userID.'&nbsp;-&nbsp;'.$username.'</td>
				<td>'.$accdet.'</td>
