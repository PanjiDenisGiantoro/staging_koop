...
if (get_session("Cookie_groupID") == 0) {
	...
	$refFileName = '?vw=uploadwingaji&mn=' . $mn . '&action=upload';
} else {
	$userID = dlookup("loans", "userID", "loanID=" . tosql($pk, "Text"));
	$refFileName = '?vw=uploadwingaji&mn=' . $mn . '&pk=' . $pk . '&userID=' . $userID . '&action=upload';
}
...
<div class="file-upload">
	...
	<div class="mt-3">
		Description :
		<input type="text" lenght="30" size="86" class="form-control" id="desc_gaji" name="desc_gaji">
	</div>
</div>
<?php
...
print '
	<center>';
if (get_session("Cookie_groupID") == 0) {
	print '<input type="button" class="btn waves-effect waves-light" style="background-color: white; color: #495057; border: 1px solid gray;" value="Kembali" onClick="window.location.href=\'?vw=biayaEdit&mn=' . $mn . '\';">';
} else {
	print '<input type="button" class="btn waves-effect waves-light" style="background-color: white; color: #495057; border: 1px solid gray;" value="Kembali" onClick="window.location.href=\'?vw=biayaEdit&mn=' . $mn . '&pk=' . $pk . '&userID=' . $userID . '\';">';
}
print '&nbsp;<input type="submit" class="btn btn-primary w-md waves-effect waves-light" value="Muat Naik Fail">													
	</center>
</form>';
include("footer.php");
