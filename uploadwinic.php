...
if (get_session("Cookie_groupID") == 0) {
	...
	$refFileName = '?vw=uploadwinic&mn=3&action=upload';
} else {
	$userID = dlookup("loans", "userID", "loanID=" . tosql($pk, "Text"));
	$refFileName = '?vw=uploadwinic&mn=922&pk=' . $pk . '&userID=' . $userID . '&action=upload';
}
...
<div class="file-upload">
	...
	<div class="mt-3">
		Description :
		<input type="text" lenght="30" size="86" class="form-control" id="desc_IC" name="desc_IC">
	</div>
</div>
<?php
...
print '
	<center>';
if (get_session("Cookie_groupID") == 0) {
	print '<input type="button" class="btn waves-effect waves-light" style="background-color: white; color: #495057; border: 1px solid gray;" value="Kembali" onClick="window.location.href=\'?vw=biayaEditHP&mn=' . $mn . '\';">';
} else {
	print '<input type="button" class="btn waves-effect waves-light" style="background-color: white; color: #495057; border: 1px solid gray;" value="Kembali" onClick="window.location.href=\'?vw=biayaEditHP&mn=' . $mn . '&pk=' . $pk . '&userID=' . $userID . '\';">';
}
