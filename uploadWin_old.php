...
//	$toFile = $ListThisDir.'\\'.$uploadFile_name;  
	...
	if ($msg <> "") 
		...
		print ' opener.document.location = "filePreview.php";
				window.close();';
	}
	print '</script>';
}
...
<html>
<head>
	<title>MyNetbase.Net - Upload File</title>
<style>
...
<form action="uploadWin.php?dir='.$dir.'" method="post" enctype="multipart/form-data">
