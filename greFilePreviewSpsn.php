...
<table border="0" cellspacing="1" cellpadding="3" width="95%" align="center" class="lineBG">
	<tr class="Header"><td>Senarai fail potongan SPSN:</td></tr>
	<tr class="Data">
		<td valign="top" height="100%" align="center">
			<table cellpadding="1" cellspacing="0" width="100%">
				<tr class="textFont">
					<td colspan="4" align="center" height="30">
					<input type="button" class="but" value="Upload Fail" onclick="Javascript:open(\'greUploadfileSpsn.php?dir='.$dir.'\', \'upload\', \'toolbar=0,scrollbars=1,location=0,status=0,menubar=0,resizable=0,width=350,height=100,left=200,top=200\');">
