...
$title     = 'Daftar Anggota yang Berhenti/Pensiun';
...
<div style="width: 100%; text-align:left">
	...
	<form name="MyForm" action=<?= $_SERVER['PHP_SELF'] ?> method="post">
		...
		<tr>
			<td class="textFont">Jumlah Data : <b>' . $GetMemberT->RowCount() . '</b></td>
		</tr>';
			} else {
				if ($q == "") {
					print '
...
<script language="JavaScript">
	...
	function ITRActionButtonClick(v) {
		...
		if (e==null) {
			...
			if (count==0) {
				alert(\'Silakan pilih rekaman/catatan yang ingin di\' + v + \'kan.\');
			} else {
