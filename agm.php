...
<div class="d-flex justify-content-between align-items-center mb-1">
    ...
    <input type="button" class="btn btn-md btn-primary" value="+ Mohon Baru" onClick="window.location.href=\'?vw=agmApply&mn='.$mn.'\'"/>
</div>';
...
<!--table border="1" cellspacing="1" cellpadding="3" width="100%" align="center" class="table"-->
			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						<td nowrap>&nbsp;</td>
						<td nowrap align="left"><b>Nombor Rujukan AGM</b></td>
	...
	if ($GetAgm->RowCount() <> 0) {
		...
		<tr>
			<td class="textFont">Jumlah Rekod : <b>' . $GetAgm->RowCount() . '</b></td>
		</tr>';
	} else {
		if ($q == "") {
			print '
