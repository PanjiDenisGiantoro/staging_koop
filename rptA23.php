 ...
 *          Filename		: 	rptA23.php
 *		   Description	:	Laporan Keseluruhan Penyata Lejer
 *          Date 		: 	13/7/2006
 *          Updated 		: 	12/7/2024
 *********************************************************************************/
session_start();
...
$sqlLoan = "SELECT DISTINCT(a.deductID) AS deduct, b.* FROM transactionacc a, generalacc b WHERE a.deductID=b.ID ORDER BY b.code ASC";
		...
		<td colspan="2">
			<table border=1  cellpadding="2" cellspacing="0" align=left width="100%">
				<tr bgcolor="#C0C0C0" style="font-family: Poppins, Helvetica, sans-serif; font-size: 8pt; font-weight: bold;">
					<th nowrap>Bil</th>
					<th nowrap align="center">Tanggal</th>
