...
if (get_session("Cookie_groupID") > 0) {
	...
	print '</select></td>
				...
				<tr>
					...
					<td class="textFont">
			        <input type="button" class="btn btn-sm btn-secondary" value="Bulanan" onClick="ITRActionButtonClick(\'depoMonthly\');" style="width:100px;">            
				...
				<tr>
					...
					<input type="button" class="btn btn-sm btn-secondary" value="Tahunan" onClick="ITRActionButtonClick(\'loanUserYearly\');" style="width:100px;">                       
					</td>
				</tr>
	...
	<tr><td	class="Label" align="center" height=50 valign=middle>
		...
		<tr valign="top" class="textFont">
			...
			print '  <div class="table-responsive">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						...
						<td nowrap colspan="3" align="center">&nbsp;Simpanan (RM)</td>
					</tr>
					<tr class="table-primary">
						<td nowrap rowspan="1" height="20">&nbsp;</td>
						<td nowrap>Nombor - Nama Anggota</td>
						<td nowrap>Kad Pengenalan</td>
			...
			while (!$GetMember->EOF && $cnt <= $pg) {
				...
				$totalKhasTK = number_format(getDepoKhasAll($GetMember->fields(userID), $yr), 2);
				print ' <tr>
			<td class="Data" align="center">' . $bil . '</td>
			<td class="Data"><input type="checkbox" name="pk[]" class="form-check-input" value="' . tohtml($GetMember->fields(userID)) . ' " ' . $objchk . '>
	...
	e = document.MyForm;
		if(e==null) {
			...
			if(count != 1) {
				...
				}else if (rpt == "depoMonthly" )  {
					url = "depoMonthly.php?yrmth=' . $yy . $mm . '&id=" + pk;
				} else if (rpt == "depoYearly" )  {
					url = "depoYearly.php?xt=9&yr=' . $yy . '&id=" + pk;
				...
				} else if (rpt == "depoYearlyAll" )  {
					url = "depoYearlyAll.php?yr=' . $yy . '&id=" + pk;
				} else if (rpt == "ShareYearlyAll" )  {
					url = "ShareYearlyAll.php?yr=' . $yy . '&id=" + pk;
				}
