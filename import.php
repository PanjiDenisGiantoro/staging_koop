...
<form name="FrmImport" action="'.$PHP_SELF.'" method="post">
...
<table border="0" cellspacing="1" cellpadding="3" width="95%" align="center">
	...
	<tr>
		...
		<table border="0" cellpadding="3" cellspacing="1" width="500" align="center" class="lineBG">
			<tr>
				<td class=Header>Import Fail Angkasa :</td>
			</tr>
			<tr>
				<td class="Data">
					<table width="100%">
						<tr><td class="textFont">Sila pilih fail :
							<input type="text" name="fileimport" size="50" value="'.$fileimport.'">
							<input type="button" class="but" value="Pilih" onclick="window.open(\'filePreview.php\',\'sel\',\'top=100,left=100,width=600,height=450,scrollbars=yes,resizable=yes,toolbars=no,location=no,menubar=no\');">
							</td>
						</tr>
						<tr>
							<td class="textFont" align="center">
							<input type="submit" name="action"  value="Kenalpasti" size="50" class="but">&nbsp;
...
//$conn->debug = true;
//print 'action '.$action;
if ($action == 'Import' || $action == 'Kenalpasti') {
	...
	if (substr($fileimport,-4,1) <> ".") {
		...
		while (!feof($fp)) { 
			...
			if ($action == 'Kenalpasti') print '<font class="textFont">'.trim($buffer).'</font><br>';
