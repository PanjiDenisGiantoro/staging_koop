...
$defaultSusun = " ORDER BY ParentMenuID, seqNB";
...
$fieldCarian = array("Menu","parentMenuID","httpLink");
$labelCarian = array("Menu","Parent Menu ID","http: link");

$column_field = array("MenuID","Menu","parentMenuID","httpLink","seqNB","");
$column_label = array("Menu ID","Menu","Parent Menu ID","http: link","Seq Number","");

$column_width = array(90,250,90,200,60, 60);
$column_align = array("left","left","left","left","left", "left");
$columnType = array("TEXT","TEXT","TEXT","TEXT","TEXT","DELETE");
$link = array("","savemenu.php","","","","menu.php");
$target = array("_self","","","","","_self");
$keyColumn = array("","MenuID","","","","MenuID");
$sortby = "MenuID";
$btnLabel = "Tambah";
$btnLink = "savemenu.php?add=1";
$btnSubmitLabel = "";
$formAction = "";
$sqlDelete = "DELETE FROM kandungan WHERE MenuID ";

$table = new MyList();
$table->setPageName("menu.php");
