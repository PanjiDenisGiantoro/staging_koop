...
class CLetter
{
	...
	function SetHeader($strHeader_)
	{
		$this->strHeader = $strHeader_;
	}
	function GetHeader()
	{
	...
	function SetContent($strContent_)
	{
		$this->strContent = $strContent_;
	}
	function GetContent()
	{
	...
	function SetFooter($strFooter_)
	{
		$this->strFooter = $strFooter_;
	}
	function GetFooter()
	{
	...
	function SetCodeName($strCodeName_)
	{
		$this->strCodeName = $strCodeName_;
	}
	...
	function SetType($strType_)
	{
		$this->strType = $strType_;
	}
	function GetType()
	{
		return $this->strType;
	...
	function SetStartYear($strValue_)
	{
		$this->strStartYear = $strValue_;
	}
	function GetStartYear()
	{
		return $this->strStartYear;
	}

	function SetReceivedDate($strValue_)
	{
		$this->strReceivedDate = $strValue_;
	}
	function GetReceivedDate()
	{
		return $this->strReceivedDate;
	}

	function SetApprovedDate($strValue_)
	{
		$this->strApprovedDate = $strValue_;
	}
	...
	function SetRejectedDate($strValue_)
	{
		$this->strRejectedDate = $strValue_;
	}
	...
	function SetReceivedDateT($strValue_)
	{
		$this->strReceivedDateT = $strValue_;
	}
	function GetReceivedDateT()
	{
		return $this->strReceivedDateT;
	}

	function SetApprovedDateT($strValue_)
	{
		$this->strApprovedDateT = $strValue_;
	}
	function GetApprovedDateT()
	{
		return $this->strApprovedDateT;
	}

	function SetRejectedDateT($strValue_)
	{
		$this->strRejectedDateT = $strValue_;
	}
	function GetRejectedDateT()
	{
		return $this->strRejectedDateT;
	}

	function SetSubject($strValue_)
	{
		$this->strSubject = $strValue_;
	}
	function GetSubject()
	{
	...
	function SetName($strValue_)
	{
		$this->strName = $strValue_;
	}
	function GetName()
	{
		return $this->strName;
	...
	function SetMemberID($strValue_)
	{
		$this->strMemberID = $strValue_;
	}
	...
	function SetStaffID($strValue_)
	{
		$this->strStaffID = $strValue_;
	}
	function GetStaffID()
	{
	...
	function SetLoginID($strValue_)
	{
		$this->strLoginID = $strValue_;
	}
	function GetLoginID()
	{
	...
	function SetNewIC($strValue_)
	{
		$this->strNewIC = $strValue_;
	}
	function GetNewIC()
	{
		return $this->strNewIC;
	}

	function SetOldIC($strValue_)
	{
		$this->strOldIC = $strValue_;
	}
	function GetOldIC()
	{
		return $this->strOldIC;
	}

	function SetFundAccount($strValue_)
	{
		$this->FundAccount = $strValue_;
	}
	...
	function SetDepartment($strValue_)
	{
		$this->strDepartment = $strValue_;
	}
	...
	function SetAddress($strValue_)
	{
		$this->strAddress = $strValue_;
	}
	function GetAddress()
	{
	...
	function SetPostcode($strValue_)
	{
		$this->strPostcode = $strValue_;
	}
	...
	function SetCity($strValue_)
	{
		$this->strCity = $strValue_;
	}
	function GetCity()
	{
		return $this->strCity;
	...
	function SetState($strValue_)
	{
		$this->strState = $strValue_;
	}
	function GetState()
	{
	...
	function SetHeadLetter($type)
	{
		if ($type == 0) {
			...
			$this->strHeadLetter =
				...
				. 'SEKATARAKYAT<br />'
				. 'Nombor 74A Tingkat Satu, Jalan Kampong Attap, Off Jalan Sulaiman,<br />'
	...
	function GetHeadLetter()
	{
		return $this->strHeadLetter;
	}

	// Fee
	function SetMonthFee($fValue_)
	{
		$this->fMonthFee = $fValue_;
	}
	function GetMonthFee()
	{
		return $this->fMonthFee;
	}
	function SetTotalFee($fValue_)
	{
		$this->fTotalFee = $fValue_;
	}
	...
	// Dividen
	function SetDividenAmount($fValue_)
	{
		$this->fDividenAmount = $fValue_;
	}
	function GetDividenAmount()
	{
		return $this->fDividenAmount;
	}
	function SetDividenBonus($fValue_)
	{
		$this->fDividenBonus = $fValue_;
	}
	function GetDividenBonus()
	{
		return $this->fDividenBonus;
	}
	function SetDividenPercentage($fValue_)
	{
		$this->fDividenPercentage = $fValue_;
	}
	function GetDividenPercentage()
	{
		return $this->fDividenPercentage;
	}
	...
	{
		$tempAddress = 'Nombor 74A Tingkat Satu, Jalan Kampong Attap, Off Jalan Sulaiman, 50460 Kuala Lumpur';
...
class CLetterLoan extends CLetter
{
	...
	function SetReceivedDateL($strValue_)
	{
		$this->strReceivedDateL = $strValue_;
	}
	function GetReceivedDateL()
	{
		return $this->strReceivedDateL;
	}

	function SetApprovedDateL($strValue_)
	{
		$this->strApprovedDateL = $strValue_;
	}
	function GetApprovedDateL()
	{
		return $this->strApprovedDateL;
	}

	function SetRejectedDateL($strValue_)
	{
		$this->strRejectedDateL = $strValue_;
	}
	function GetRejectedDateL()
	{
		return $this->strRejectedDatLe;
	}

	// Loan set/get function
	function SetLoanID($strValue_)
	{
		$this->strLoanID = $strValue_;
	}
	function GetLoanID()
	{
		return $this->strLoanID;
	}

	function SetRefNum($strType_)
	{
		$this->strRefNum = $strType_;
	}
	function GetRefNum()
	{
		return $this->strRefNum;
	}

	function SetLoanName($strValue_)
	{
		$this->strLoanName = $strValue_;
	}
	function GetLoanName()
	{
		return $this->strLoanName;
	}

	function SetLoanBondNum($strValue_)
	{
		$this->strLoanBondNum = $strValue_;
	}
	function GetLoanBondNum()
	{
		return $this->strLoanBondNum;
	}

	//------------------
	function SetLoanPeriod($nValue_)
	{
		$this->nLoanPeriod = $nValue_;
	}
	function GetLoanPeriod()
	{
		return $this->nLoanPeriod;
	}

	function SetLoanPeriodMonth($nValue_)
	{
		$this->nLoanPeriodMonth = $nValue_;
	}
	function GetLoanPeriodMonth()
	{
		return $this->nLoanPeriodMonth;
	}

	function SetLoanPeriodMonthLessOne($nValue_)
	{
		$this->nLoanPeriodMonthLessOne = $nValue_;
	}
	function GetLoanPeriodMonthLessOne()
	{
		return $this->nLoanPeriodMonthLessOne;
	}

	//------------------------
	function SetLoanAmount($fValue_)
	{
		$this->fLoanAmount = $fValue_;
	}
	...
	function SetLoanProfitRate($fValue_)
	{
		$this->fLoanProfitRate = $fValue_;
	}
	function GetLoanProfitRate()
	{
		return $this->fLoanProfitRate;
	}

	function SetLoanAmtProfit($fValue_)
	{
		$this->ftotalAmtProfit = $fValue_;
	}
	function GetLoanAmtProfit()
	{
		return $this->ftotalAmtProfit;
	}

	function SetLoanAmountStr($fValue_)
	{
		$this->strloanword = $fValue_;
	}
	function GetLoanAmountStr()
	{
		return $this->strloanword;
	}

	function SetLoanJualanStr($fValue_)
	{
		$this->strjualanword = $fValue_;
	}
	function GetLoanJualanStr()
	{
		return $this->strjualanword;
	}
	//-----------------

	function SetmonthlyAmt($fValue_)
	{
		$this->monthlyAmt = $fValue_;
	}
	...
	function SetlastmonthlyAmt($fValue_)
	{
		$this->lastmonthlyAmt = $fValue_;
	}
	function GetlastmonthlyAmt()
	{
		return $this->lastmonthlyAmt;
	}

	function SetbenefitAmt($fValue_)
	{
		$this->benefitAmt = $fValue_;
	}
	function GetbenefitAmt()
	{
		return $this->benefitAmt;
	}

	function SetlastbenefitAmt($fValue_)
	{
		$this->lastbenefitAmt = $fValue_;
	}
	function GetlastbenefitAmt()
	{
		return $this->lastbenefitAmt;
	}

	//-----------------------
	function SettotalPayed($fValue_)
	{
		$this->totalPayed = $fValue_;
	}
	...
	function SettotalBalance($fValue_)
	{
		$this->totalBalance = $fValue_;
	}
	...
	function Setbayarankhidmat($fValue_)
	{
		$this->bertindih_caj = $fValue_;
	}
	function Getbayarankhidmat()
	{
		return $this->bertindih_caj;
	}
	...
	function GetGuarantorName1()
	{
		return $this->strGuarantorName1;
	}
	function GetGuarantorID1()
	{
		return $this->strGuarantorID1;
	}
	function GetGuarantorNewIC1()
	{
		return $this->strGuarantorNewIC1;
	}
	...
	function GetGuarantorName2()
	{
		return $this->strGuarantorName2;
	}
	function GetGuarantorID2()
	{
		return $this->strGuarantorID2;
	}
	function GetGuarantorNewIC2()
	{
		return $this->strGuarantorNewIC2;
	}
	...
	function GetGuarantorName3()
	{
		return $this->strGuarantorName3;
	}
	function GetGuarantorID3()
	{
		return $this->strGuarantorID3;
	}
	function GetGuarantorNewIC3()
	{
		return $this->strGuarantorNewIC3;
	}
