...
if (get_session("Cookie_groupID") > 0) {
 ...
 <td class="Data" >&nbsp;';
	        ...
	        <td class="Data" align="right" >&nbsp;';
				...
				print '</td>
      <td class="Data" align="center" width="5%">&nbsp;<a href="' . $sFileName . '?IDtype=' . $GetMember->fields(ID) . '&ID=' . $ID . '&code=2" title="perbarui"><img src="b_edit.png"></a> <input size="7" type="hidden" name="IDtype" value="' . $IDtype . '" ><input size="7" type="hidden" name="ID" value="' . $ID . '" ></td>
