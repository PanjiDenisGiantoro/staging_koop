...
$title  = 'Senarai Advance Payment Ditolak';
		...
		<td colspan="9">
			<table border=0  cellpadding="2" cellspacing="1" align=left width="100%" bgcolor="999999">
				...
				if ($rs->RowCount() <> 0) {	
					...
					print '
					<tr style="font-family: Poppins, Helvetica, sans-serif; font-size: 8pt;" bgcolor="FFFFFF">
						<td colspan="11" align="center"><b>- Tidak data yang dicetak-</b></td>
					</tr>';
				}
print '		</table> 
		</td>
...
<center><tr><td colspan="11"><font size="1" color="#999999"><b>'.$retooFetis.'</b></font></td></tr></center>';
?>