...
$refFileName = '?vw=uploadwingajiA&mn=' . $mn . '&pk=' . $pk . '&action=upload';
...
if ($action == 'upload') {
    ...
    if (in_array($file_ext, $allowed_file_types) && ($filesize < 1048576)) {
        ...
        if (file_exists("upload_gaji/" . $newfilename)) {
            ...
            header("Location: ?vw=uploadwingajiA&mn=$mn&pk=$pk&action=upload");
            exit();
        } else {
...
print '<input type="button" class="btn waves-effect waves-light" style="background-color: white; color: #495057; border: 1px solid gray;" value="Kembali" onClick="window.location.href=\'?vw=biayaEditA&mn=' . $mn . '&pk=' . $pk . '\';">';
