...
<script>
window.status="Sistem Keanggotaan Koperasi versi 2.0 ";
</script>
...
<table width="100%" cellpadding="0" cellspacing="0" style="background-image: url(images/shade-bkrm-01.gif)">
	...
	<td>
		...
		<table cellpadding="2" cellspacing="0">
			<tr>
				<td>|</td>
				<td>
					<font class="blue"><b>Selamat Datang,</b></font></td>
		<? 	
	...
	?>
				<td><div class="black"><a href="page.php" class="black" target="mainFrame"><b>Login</b></a></div></td>
	<?
			}
	?>
		<td><div class="black">|</div></td>
