...
if ($GetReceipts->RowCount() <> 0) {
			...
			<td valign="top">
				<table border="0" cellspacing="1" cellpadding="2" width="100%" class="table table-sm table-striped">
					<tr class="table-primary">
						...
						<td nowrap><div style="text-align: right; white-space: nowrap;">Jumlah Purchase<br>Invois (RP)</div></td>
	...
	while (!$GetReceipts->EOF && $cnt <= $pg) {
		...
		$edit 		= '<a href="' . $sFileRef . '&action=view&no_bill=' . tohtml($GetReceipts->fields['no_bill']) . '&yy=' . $yy . '&mm=' . $mm . '" title="perbarui"><i class="mdi mdi-lead-pencil text-warning" style="font-size: 1.4rem;"></i></a>';
