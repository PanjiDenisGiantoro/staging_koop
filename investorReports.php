<?php
/*********************************************************************************
*          Project		:	KOPONAS RUMAH PERANGINAN
*          Filename		: 	investorReports.php
*          Date 		: 	06/10/2023
*********************************************************************************/
include("header.php");	
...
<div>&nbsp;</div>
	<tr>
		...
		<li id="print" class="textFont"><a href="#" onclick="selectPelaburan('rptInvest2')">Laporan Invois Pelaburan</a></li>
		<li id="print" class="textFont"><a href="#" onclick="selectPelaburan('rptInvest3')">Laporan Baucer Pelaburan</a></li>
		<li id="print" class="textFont"><a href="#" onclick="selectPelaburan('rptInvest4')">Laporan Resit Pelaburan</a></li>
		<li id="print" class="textFont"><a href="#" onclick="selectPembiayaan3('rptAgingYear')">Collection Report Berdasarkan Tahun</a></li>
		<li id="print" class="textFont"><a href="#" onclick="selectPembiayaan2('rptAgingInvest')">Laporan Aging Pelaburan</a></li>
	</td>
	</tr>
...
<script>
	...
	function selectPembiayaan2(rpt) {
		url = "selYear9.php?rpt="+rpt+"";
		window.open(url ,"pop","top=100,left=100,width=500,height=100,scrollbars=no,resizable=no,toolbars=no,location=no,menubar=no");	
	
	} 

	function selectPembiayaan3(rpt) {
		url = "selYear9B.php?rpt="+rpt+"";
		window.open(url ,"pop","top=100,left=100,width=500,height=100,scrollbars=no,resizable=no,toolbars=no,location=no,menubar=no");	
	...
	function selectUrusniaga(rpt) {
		...
		} else if (rpt == "rptAgingMonth") {
			url = "selMthYear.php?rpt="+rpt+"&id=ALL";
		} else if (rpt == "rptAgingInvest") {
			url = "selMthYear.php?rpt="+rpt+"&id=ALL";
		} else {
			url = "selYear.php?rpt="+rpt+"&id=ALL";
		}
